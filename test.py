...
from data import BaseTransform, VOCAnnotationTransform, VOCDetection
from ssd import build_ssd
from utils.xml import clear_xmls, init_xmls
...
# 结果输出路径
devkit_path = "../predicted_file_level_%s"
...
parser.add_argument(
    "--trained_model",
    default="weights/ssd300_COCO_60600.pth",
    type=str,
    help="Trained state_dict file path to open",
)
parser.add_argument(
    "--save_folder", default="out/", type=str, help="File path to save results"
)
parser.add_argument(
...
parser.add_argument(
    "--image_root", default=IMAGE_ROOT, help="Location of VOC root directory"
)
parser.add_argument(
    "--annotation_root",
    default=ANNOTATION_ROOT,
    help="Location of ANNOTATION root directory",
)
parser.add_argument(
    "--cleanup",
    default=True,
...
annopath = os.path.join(args.annotation_root, "%s.xml")
imgpath = os.path.join(args.image_root, "%s.jpg")
imgsetpath = os.path.join(args.annotation_root, "{:s}.txt")
...
def parse_rec(filename):
    ...
    tree = ET.parse(TEMP_PATH + os.sep + filename + ".xml")
    objects = []
